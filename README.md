...
curl -L https://github.com/0xNetuser/flux-panel/releases/download/1.8.10/docker-compose.yml -o docker-compose.yml
```
...
services:
  gost-node:
    image: 0xnetuser/gost-node:1.8.10
