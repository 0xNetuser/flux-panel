...
curl -L https://github.com/0xNetuser/flux-panel/releases/download/1.8.5/docker-compose.yml -o docker-compose.yml
```
...
services:
  gost-node:
    image: 0xnetuser/gost-node:1.8.5
...
- **默认 Xray 版本更新**：Docker 镜像默认 Xray 从 1.8.54 更新为 25.1.30
