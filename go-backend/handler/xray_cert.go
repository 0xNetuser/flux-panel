...
func XrayCertCreate(c *gin.Context) {
	...
	c.JSON(http.StatusOK, service.CreateXrayTlsCert(d))
}
...
func XrayCertList(c *gin.Context) {
	...
	c.ShouldBindJSON(&d)
	c.JSON(http.StatusOK, service.ListXrayTlsCerts(d.NodeId))
}
...
func XrayCertDelete(c *gin.Context) {
	...
	c.JSON(http.StatusOK, service.DeleteXrayTlsCert(d.ID))
}
